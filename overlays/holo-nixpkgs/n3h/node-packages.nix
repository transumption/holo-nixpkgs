...
let
  sources = {
    ...
    "better-sqlite3-5.4.0" = {
      ...
      version = "5.4.0";
      src = fetchurl {
        url = "https://registry.npmjs.org/better-sqlite3/-/better-sqlite3-5.4.0.tgz";
        sha512 = "Uj1ZYOcq1GtFyFgJgqMVDoDLTy1B1pM9+bULnlX8szRX4cPjE/7JbKxCzQGhYlZlLkHQvtXXhCZ3skqsQ2byMA==";
      };
    };
    "bip39-2.5.0" = {
      name = "bip39";
  ...
  args = {
    ...
    src = fetchgit {
      url = "https://github.com/holochain/n3h";
      rev = "v0.0.20-alpha";
      sha256 = "1948476swj7qrk9v9wqwp5y8nvf9d2jv5zx6msbc2gwdax1yminc";
    };
    dependencies = [
