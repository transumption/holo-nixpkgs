...

{
  ...
  services.hydra.extraConfig = ''
    ...
    store_uri = s3://holo-cache?endpoint=s3.us-west-1.wasabisys.com&parallel-compression=1&secret-key=/var/lib/hydra/queue-runner/keys/cache.holo.host-1/secret
